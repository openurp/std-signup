...
[@b.grid items=signupInfoes var="signupInfo"]
  ...
  [@b.row]
    ...
    [@b.col title="专业一" width="20%"]${(signupInfo.firstMajor.institution.name)!} ${(signupInfo.firstMajor.name)!}[/@]
    [@b.col title="专业二"]${(signupInfo.secondMajor.name)!} [/@]
    [@b.col width="5%" property="updatedAt" title="报名时间"]${signupInfo.updatedAt?string("MM-dd")}[/@]
  [/@]
[/@]
[@b.foot/]
