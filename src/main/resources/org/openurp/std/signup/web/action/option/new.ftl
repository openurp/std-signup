...
[@b.tabs]
  ...
  [@b.form action=sa theme="list"]
    ...
    [@b.select name="major.id" label="报名专业" value="${(signupOption.major.id)!}" multiple="true"
    style="width:400px;" items=majors empty="..." required="true" keyName="id" option=r"${item.institution.name} ${item.name}"/]
