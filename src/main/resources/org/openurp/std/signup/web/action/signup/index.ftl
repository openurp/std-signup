...
<div style="text-align: center;margin-top: 150px">
  ...
  <div style="margin-bottom: 20px;">
   <p style="font-size:20px">辅修专业报名与查询</p>
  </div>
  ...
  <div style="margin-top: 20px;">
    <button class="btn btn-default" onclick="checkInfo(this.form)">查询</button>
     [#if setting?? && setting.project.minor]
       [@b.a class="btn btn-default" href="!editNew?signupInfo.inside=1&setting.id="+setting.id]直接报名[/@]
     [/#if]
  </div>
</div>
